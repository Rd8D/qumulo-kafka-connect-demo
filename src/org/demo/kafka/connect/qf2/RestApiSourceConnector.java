...
public class RestApiSourceConnector extends SourceConnector {
	...
	private static final ConfigDef CONFIG_DEF = new ConfigDef()
			.define(DIR_CONFIG, Type.STRING, Importance.HIGH, "Source directory")
	...
	public void start(Map<String, String> props) {
		...
		if (this.topic == null || this.topic.isEmpty())
			throw new ConnectException("RestApiSourceConnector configuration must include 'topic' setting");
		if (this.topic.contains(","))
			throw new ConnectException("RestApiSourceConnector should only have a single topic when used as a source.");
