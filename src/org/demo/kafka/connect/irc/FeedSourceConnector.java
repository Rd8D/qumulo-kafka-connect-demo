...
/**
 * A Generic Kafka Connector which takes a list of channels from an IRC server
 * and creates 1 or more tasks depending on maxTasks configuration argument.
 */
...
public class FeedSourceConnector extends SourceConnector {
	...
	public ConfigDef config() {
		return new ConfigDef()
				.define(IRC_HOST_CONFIG, ConfigDef.Type.STRING, ConfigDef.Importance.HIGH,
						"IRC server host name, e.g `irc.wikimedia.org`")
				.define(IRC_PORT_CONFIG, ConfigDef.Type.INT, ConfigDef.Importance.HIGH, "IRC server port, e.g. `6667`")
				.define(IRC_CHANNELS_CONFIG, ConfigDef.Type.STRING, ConfigDef.Importance.HIGH,
						"coma-separated list of IRC channels to subscribe to, e.g. `#en.wikipedia`")
				.define(TOPIC_CONFIG, ConfigDef.Type.STRING, ConfigDef.Importance.HIGH,
						"kafka topic to publish the feed into");
	}
