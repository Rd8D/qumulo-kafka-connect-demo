...
"${_JAVA}" -Xms256M -Xmx2G -server \
 ...
 -Dfile.encoding=UTF-8 org.demo.kafka.connect.qf2.ConnectStandalone "${build_root}/conf/connect-standalone-qf2.properties" \
 "${build_root}/conf/connect-irc-source.properties" "${build_root}/conf/connect-qf2-restapi-source.properties" \
 "${build_root}/conf/connect-qf2-restapi-sink.properties"
